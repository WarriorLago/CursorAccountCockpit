...
<p align="center">
  <a href="https://github.com/WarriorLago/CursorAccountCockpit/releases/latest"><strong>Download 0.2.38</strong></a>
  ·
...
## Latest release 0.2.38

Download only from this repo’s official Release assets (direct links):

| File | Description |
| --- | --- |
| [Cursor-Account-Cockpit-0.2.38-x64-setup.exe](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.38/Cursor-Account-Cockpit-0.2.38-x64-setup.exe) | Windows x64 installer |
| [Cursor-Account-Cockpit-0.2.38-portable.exe](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.38/Cursor-Account-Cockpit-0.2.38-portable.exe) | Windows x64 portable build |
| [SHA256SUMS.txt](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.38/SHA256SUMS.txt) | SHA-256 checksums |
| [latest.json](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.38/latest.json) | In-app update manifest |
