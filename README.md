...
<p align="center">
  <a href="https://github.com/WarriorLago/CursorAccountCockpit/releases/latest"><strong>下载 0.2.39</strong></a>
  ·
...
| 文件 | 说明 |
| --- | --- |
| [Cursor-Account-Cockpit-0.2.39-x64-setup.exe](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.39/Cursor-Account-Cockpit-0.2.39-x64-setup.exe) | Windows x64 安装包 |
| [Cursor-Account-Cockpit-0.2.39-portable.exe](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.39/Cursor-Account-Cockpit-0.2.39-portable.exe) | Windows x64 便携版 |
| [SHA256SUMS.txt](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.39/SHA256SUMS.txt) | SHA-256 校验 |
| [latest.json](https://github.com/WarriorLago/CursorAccountCockpit/releases/download/v0.2.39/latest.json) | 应用内更新清单 |
